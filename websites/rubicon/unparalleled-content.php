<?php 
   ...
   // Site Assests
   $css = array('css/normalize.min.css', 'css/style.css');
   
   $js = array('js/cycle.js','js/rubicon.js', 'js/fixScroll.js');
        ...
        <div class="content">
            	...
            	<div class="col2" id="unparalleld-page">
                    ...
                    <ul id="unparalleled-nav">
                        ...
                        <li><a id="opportunity" class="active">Opportunity</a><span class="blue-arrow"></span></li>
